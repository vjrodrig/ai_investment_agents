...
Verás a cada agente trabajar en pantalla y, al final, la cartera quedará guardada en
`output/`.
...
│   └── orchestrator.py    ·  coordina al equipo e imprime cada turno
├── docs/
│   ├── COMO_FUNCIONA.md
│   └── COMO_EDITAR_AGENTES.md
└── output/                ← aquí se guardan las carteras generadas
```
